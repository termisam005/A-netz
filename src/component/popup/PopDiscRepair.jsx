...
const PopDiscRepair = ({ open, close }) => {
        ...
        <div className={open ? 'modal open' : 'modal'}>
            ...
            <div className={"pop_body pop_medium_new"}>
                ...
                <div className="popn_bottom">
                    ...
                    <ButtonComponent onClick={openApply} className={'btn_default'} txt={'저장'} />
                </div>
            </div>

            <PopAlert open={applyPop} close={closeApply} title={'알림'} link={close}>
                <p className="pop_txt m-b-14">
                    변경된 내용을 저장하시겠습니까?
                </p>
            </PopAlert>
