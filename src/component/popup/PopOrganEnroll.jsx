...
const PopOrganEnroll = ({ open, close }) => {

    //관련문서 등록
    const [organEnrollPop, setOrganEnroll] = useState(true);
    ...
    return (
        <div className={open ? 'modal open' : 'modal'}>
            ...
            <div className={organEnrollPop? "pop_body pop_medium_new" : "pop_body none pop_medium_new"}>
                <p onClick={close} className="del24">
                    <ImgComponent src={'del24.svg'} />
                </p>
                <div className="popn_top">
                    <h2 className="h2_b20">조직 등록</h2>
                </div>
                <div className="popn_cont">
                    ...
                    <section className='popn_contain org_enorll scroll'>
                        <dl className='dl_enroll'>
                            <dt>유형</dt>
                            <dd>
                                <span className='tlt'>구역/차량명</span>
                            </dd>
                        </dl>
