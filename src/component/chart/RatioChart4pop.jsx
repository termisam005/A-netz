...
const RatioChart4pop = () => {
  const chartRef = useRef(null);

  useEffect(() => {
    am4core.addLicense("CH237726473");

    let chart = am4core.create("chartRatio4pop", am4charts.PieChart);
  ...
  return (
    <div id={'chartRatio4pop'} style={{ width: "100%", height: "95%", fontSize:"1rem"}}/>
  );
}

export default RatioChart4pop;
