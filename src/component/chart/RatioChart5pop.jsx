...
const RatioChart5pop = () => {
  const chartRef = useRef(null);

  useEffect(() => {
    am4core.addLicense("CH237726473");

    let chart = am4core.create("chartRatio5pop", am4charts.PieChart);
    ...
    pieSeries.labels.template.opacity = 0.8;
    pieSeries.labels.template.padding(16, 16, 16, 16);
  ...
  return (
    <div id={'chartRatio5pop'} style={{ width: "100%", height: "95%", fontSize:"1rem"}}/>
  );
}

export default RatioChart5pop;
