...
const SalseChart01 = () => {
  ...
  useEffect(() => {
    ...
    let chart = am4core.create("chartdiv01", am4charts.XYChart);
    ...
    columnSeries.columns.template.fill = am4core.color("#00A388");
  ...
  return (
    <div id={'chartdiv01'} style={{ width: "100%", height: "108%", fontSize:"0.75rem"}}/>
  );
}

export default SalseChart01;
